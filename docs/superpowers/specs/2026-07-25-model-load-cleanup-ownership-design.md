...
21. confirm no change to `LoadModelOnAll`, `Session.GenClaim`, browser code, launchers, extensions, generated content, user data, or excluded adjacent findings;
22. inspect the exact commit/file range; and
