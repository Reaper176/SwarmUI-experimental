...
public static class Permissions
{
    ...
    public static PermInfo LocalKritaBridge = Register(new("local_krita_bridge", "Local Krita Bridge", "Allows access to the local-only Krita launch and return bridge. Only functions if you're on the same PC as the server.", PermissionDefault.USER, GroupSpecial, PermSafetyLevel.POWERFUL));
