...
class ImageFullViewHelper {
    ...
    showImage(src, metadata, batchId = null) {
        ...
        let isVideo = mediaType == 'video' ? isVideoExt(src) : false;
...
function setCurrentImage(src, metadata = '', batchId = '', previewGrow = false, smoothAdd = false, canReparse = true, isPlaceholder = false) {
    ...
    let data = null;
    function currentImageFinalResolution() {
        if (mediaType != 'image') {
            return null;
        }
    ...
    img.onload = () => {
        ...
        if (data) {
            data.innerHTML = formatMetadata(metadata, currentImageFinalResolution());
        }
    };
    if (mediaType == 'video' || mediaType == 'audio') {
    ...
    data = createDiv(null, 'current-image-data');
    data.innerHTML = formatMetadata(metadata, currentImageFinalResolution());
