...
// Export a compatibility namespace for gradual modularization.
// Consumers can keep using the global functions, or reference SwarmUtil.<fn> to be explicit.
if (typeof window !== 'undefined') {
    window.SwarmUtil = window.SwarmUtil || {
        getSwarmXhrTimeoutMs: getSwarmXhrTimeoutMs,
        sendJsonToServer: sendJsonToServer,
        getJsonDirect: getJsonDirect,
        getWSAddress: getWSAddress,
        createSpan: createSpan,
        createDiv: createDiv,
        escapeHtml: escapeHtml,
        escapeHtmlNoBr: escapeHtmlNoBr,
        unescapeHtml: unescapeHtml,
        escapeJsString: escapeJsString,
        escapeHtmlForUrl: escapeHtmlForUrl,
        isHtmlSpanStyleAllowed: isHtmlSpanStyleAllowed,
        safeHtmlOnly: safeHtmlOnly,
        splitWithQuoting: splitWithQuoting,
        linearToPot: linearToPot,
        potToLinear: potToLinear,
        findParentOfClass: findParentOfClass,
        ...
        setTextSelRange: setTextSelRange,
        getTextSelRange: getTextSelRange,
        toDataURL: toDataURL,
        copyImageToClipboard: copyImageToClipboard,
        roundTo: roundTo,
        roundToAuto: roundToAuto,
        roundToStrAuto: roundToStrAuto,
        ...
        getRequiredElementById: getRequiredElementById,
        downloadPlainText: downloadPlainText,
        microYamlParse: microYamlParse,
        parseCsvLine: parseCsvLine,
        readFileText: readFileText,
        numberToLetters: numberToLetters,
        convertRemToPixels: convertRemToPixels,
        getRadioSelectionInFieldset: getRadioSelectionInFieldset,
        imageToSmallPreviewData: imageToSmallPreviewData,
        ...
        strBeforeLast: strBeforeLast,
        simpleAsteriskedMatcher: simpleAsteriskedMatcher,
        guessMimeTypeForExtension: guessMimeTypeForExtension,
        isVideoExt: isVideoExt,
        isAudioExt: isAudioExt,
        ...
        trimEndSpaces: trimEndSpaces,
        trimSpaces: trimSpaces,
        ansiHtml: ansiHtml,
        stripHtmlToText: stripHtmlToText,
        forceSetDropdownValue: forceSetDropdownValue,
        largeCountStringify: largeCountStringify,
        fileSizeStringify: fileSizeStringify,
        durationStringify: durationStringify,
        filterDistinctBy: filterDistinctBy,
        getInputVal: getInputVal,
        setInputVal: setInputVal,
        formatNumberClean: formatNumberClean,
