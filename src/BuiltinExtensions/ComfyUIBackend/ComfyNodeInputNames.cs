...
public static class ComfyNodeInputNames
{
    ...
    public static class ImageScaleForMP
    {
        ...
        /// <summary>Input name for the target image height in pixels.</summary>
        public const string Height = "height";
        /// <summary>Input name for the source image.</summary>
        public const string Image = "image";
        /// <summary>Input name for the target image width in pixels.</summary>
        public const string Width = "width";
    }
    ...
    /// <summary>Input names for the node that ensures audio exists and pads it when shorter than the minimum duration.</summary>
    public static class EnsureAudio
    {
        /// <summary>Input name for the source audio.</summary>
        public const string Audio = "audio";
        /// <summary>Input name for the minimum target duration.</summary>
