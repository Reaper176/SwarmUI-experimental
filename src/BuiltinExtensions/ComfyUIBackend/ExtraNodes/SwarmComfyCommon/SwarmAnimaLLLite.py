"""Swarm-bundled ComfyUI node for Anima ControlNet-LLLite.
...
Adapted from https://github.com/kohya-ss/ComfyUI-Anima-LLLite
"""
...
class SwarmAnimaLLLite:
    ...
    DESCRIPTION = "Applies Anima ControlNet-LLLite weights to an Anima MODEL using an IMAGE control input. LLLite weights are loaded from the ControlNet model folder."
...
NODE_CLASS_MAPPINGS = {
    "SwarmAnimaLLLite": SwarmAnimaLLLite,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "SwarmAnimaLLLite": "Apply Anima ControlNet-LLLite",
}
