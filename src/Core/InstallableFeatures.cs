...
public static class InstallableFeatures
{
    ...
    public record class ComfyInstallableFeature(string DisplayName, string ID, string URL, string Author, string Notice = null, bool SkipPipCache = false, bool AutoInstall = false, bool RunInstallScript = false);
    ...
    static InstallableFeatures()
    {
        ...
        RegisterInstallableFeature(new("Segment Anything 3", "sam3", "https://github.com/PozzettiAndrea/ComfyUI-SAM3", "PozzettiAndrea", RunInstallScript: true));
        ...
        RegisterInstallableFeature(new("ComfyUI Inpaint Nodes", "inpaint_nodes", "https://github.com/Acly/comfyui-inpaint-nodes", "Acly"));
    }
}
