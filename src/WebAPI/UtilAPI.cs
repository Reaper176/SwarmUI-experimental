...
public static class UtilAPI
{
        ...
        string Partial, string LoadingText, PermInfo Permission, bool ShowPermissionOnHeader)
    {
        ...
        public string TabId { get; init; } = TabId;
